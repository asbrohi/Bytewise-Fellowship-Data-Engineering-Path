...
// Create staging
-- DROP STAGE redfin_database.external_stage_schema.redfinanalyticsaws;
CREATE OR REPLACE STAGE redfin_database.external_stage_schema.redfinanalyticsaws 
    url="s3://redfinanalyticsaws/"
    credentials=(aws_key_id='xxxx'
    aws_secret_key='xxxxx')
    FILE_FORMAT = redfin_database.file_format_schema.format_csv;

list @redfin_database.external_stage_schema.redfinanalyticsaws;
...
FROM @redfin_database.external_stage_schema.redfinanalyticsaws;
